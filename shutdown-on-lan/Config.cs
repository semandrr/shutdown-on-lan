...
public class Config
{
    ...
    public static readonly string shutdownMessage = "Received WoL packet. The system will shutdown after 1 minute."; // if instantShutdown is not enabled, this message will be displayed to users before shutting down the system, leave blank if you don't want that
